...
def is_valid(customer_account_number):
    try:
        customer_database = open(r"D:\Users\sreet\Desktop\ms\cv\inprogrammer\database\Customer\customerDatabase.txt")
    except FileNotFoundError:
        os.makedirs(r"D:\Users\sreet\Desktop\ms\cv\inprogrammer\database\Customer\customerDatabase.txt", exist_ok=True)
        print("# Customer database doesn't exists!\n# New Customer database created automatically.")
        customer_database = open(r"D:\Users\sreet\Desktop\ms\cv\inprogrammer\database\Customer\customerDatabase.txt", "a")
...
def delete_customer_account(identity, choice):  # choice 1 for admin, choice 2 for customer
    ...
    customer_database = open(r"D:\Users\sreet\Desktop\ms\cv\inprogrammer\database\Customer\customerDatabase.txt", "w")
...
def create_admin_account(identity, password):
    admin_database = open(r"D:\Users\sreet\Desktop\ms\cv\inprogrammer\database\Admin\adminDatabase.txt", "a")
    admin_id = identity
    admin_password = password
    append_data(r"D:\Users\sreet\Desktop\ms\cv\inprogrammer\database\Admin\adminDatabase.txt", admin_id + "\n" + admin_password + "\n" + "*\n")
...
def delete_admin_account(identity):
    admin_database = open(r"D:\Users\sreet\Desktop\ms\cv\inprogrammer\database\Admin\adminDatabase.txt")
    data_collector = ""
    flag = 0
    ...
    admin_database = open(r"D:\Users\sreet\Desktop\ms\cv\inprogrammer\database\Admin\adminDatabase.txt", "w")
...
def check_credentials(identity, password, choice,
    ...
    folder_name = r"D:\Users\sreet\Desktop\ms\cv\inprogrammer\database\Admin" if (choice == 1) else r"D:\Users\sreet\Desktop\ms\cv\inprogrammer\database\Customer"
    file_name = r"\adminDatabase.txt" if (choice == 1) else r"\customerDatabase.txt"
...
class Error:
    def __init__(self, window=None):
        ...
        global _img0
        _img0 = tk.PhotoImage(file=r"D:\Users\sreet\Desktop\ms\cv\inprogrammer\images\error_image.png")
...
class adminLogin:
    def __init__(self, window=None):
        ...
        global _img0
        _img0 = tk.PhotoImage(file=r"D:\Users\sreet\Desktop\ms\cv\inprogrammer\images\adminLogin1.png")
        ...
        global _img1
        _img1 = tk.PhotoImage(file=r"D:\Users\sreet\Desktop\ms\cv\inprogrammer\images\user1.png")
        ...
        global _img2
        _img2 = tk.PhotoImage(file=r"D:\Users\sreet\Desktop\ms\cv\inprogrammer\images\lock1.png")
        ...
        global _img3
        _img3 = tk.PhotoImage(file=r"D:\Users\sreet\Desktop\ms\cv\inprogrammer\images\bank1.png")
        ...
        global admin_img
        admin_img = tk.PhotoImage(file=r"D:\Users\sreet\Desktop\ms\cv\inprogrammer\images\adminLogin1.png")
...
class CustomerLogin:
    def __init__(self, window=None):
        ...
        Label2.place(relx=0.067, rely=0.283, height=181, width=233)
        global _img0
        _img0 = tk.PhotoImage(file=r"D:\Users\sreet\Desktop\ms\cv\inprogrammer\images\customer.png")
        Label2.configure(image=_img0)
        ...
        global customer_img
        customer_img = tk.PhotoImage(file=r"D:\Users\sreet\Desktop\ms\cv\inprogrammer\images\customer.png")
...
class createCustomerAccount:
    ...
    def create_acc(self, customer_account_number, name, account_type, date_of_birth, mobile_number, gender, nationality,
        ...
        append_data(r"D:\Users\sreet\Desktop\ms\cv\inprogrammer\database\Customer\customerDatabase.txt", data)
...
class depositMoney:
    def __init__(self, window=None):
        ...
        p1 = PhotoImage(file=r'D:\Users\sreet\Desktop\ms\cv\inprogrammer\images\deposit_icon.png')
        window.iconphoto(True, p1)
...
class withdrawMoney:
    def __init__(self, window=None):
        ...
        p1 = PhotoImage(file=r'D:\Users\sreet\Desktop\ms\cv\inprogrammer\images\withdraw_icon.png')
        window.iconphoto(True, p1)
        window.configure(borderwidth="2")
        window.configure(background="#f2f3f4")
